...
def generate_pdf(payment_schedule, property_price, installment_period):
    ...
    # Первая страница:
    TOP_MARGIN_FIRST_PAGE = 0.8 * inch  # Отступ от верхнего края страницы до начала основной контентной области
    BOTTOM_MARGIN_FIRST_PAGE = 2.2 * inch  # Отступ от нижнего края страницы до низа сноски

    # Последующие страницы:
    TOP_MARGIN_LATER_PAGES = 0.8 * inch  # Отступ от верхнего края страницы до начала основной контентной области
